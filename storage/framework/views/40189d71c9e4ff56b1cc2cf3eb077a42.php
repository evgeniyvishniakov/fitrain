    ...
    <div class="relative top-10 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-2/3 xl:w-1/2 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            <div class="flex items-center justify-between mb-6">
                <h3 class="text-lg font-medium text-gray-900" id="modalTitle"><?php echo e(__('common.create_measurement_title')); ?></h3>
...
function showAddMeasurementModal() {
    ...
    if (modalTitle) modalTitle.textContent = '<?php echo e(__('common.create_measurement_title')); ?>';
...
function editMeasurement(measurementId) {
    ...
    if (modalTitle) modalTitle.textContent = '<?php echo e(__('common.edit_measurement_title')); ?>';
