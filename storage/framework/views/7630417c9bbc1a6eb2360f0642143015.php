                        ...
                        <template x-for="workout in currentWorkoutDetails.workouts" :key="workout.id">
                            <div class="workout-row">
                                ...
                                <span class="workout-athlete">
                                    ...
                                    <span x-text="workout.athlete_name || '<?php echo e(__('common.athlete_not_specified')); ?>'"></span>
                                </span>
                                <span class="workout-time">
                                    <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                    </svg>
                                    <span x-text="workout.time ? workout.time.substring(0, 5) : '<?php echo e(__('common.time_not_specified')); ?>'"></span>
                                </span>
