                    ...
                    <div class="space-y-4">
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 1rem;">
                            <?php $__currentLoopData = \App\Models\Language::getActive(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer hover:bg-gray-50 <?php echo e(($user->language_code ?? 'ru') === $language->code ? 'border-blue-500 bg-blue-50' : 'border-gray-200'); ?>" style="flex: 1; min-width: 200px; max-width: 300px;">
                                    <input type="radio" name="language_code" value="<?php echo e($language->code); ?>" 
                    ...
                    <div class="space-y-4">
                        ...
                        <div style="display: flex; flex-wrap: wrap; gap: 1rem;">
                            <?php $__currentLoopData = \App\Models\Currency::getActive(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer hover:bg-gray-50 <?php echo e(($user->currency_code ?? 'RUB') === $currency->code ? 'border-blue-500 bg-blue-50' : 'border-gray-200'); ?>" style="flex: 1; min-width: 200px; max-width: 300px;">
                                    <input type="radio" name="currency_code" value="<?php echo e($currency->code); ?>" 
...
async function saveSettings(type, code = null) {
    const languageCode = code && type === 'language' ? code : document.querySelector('input[name="language_code"]:checked')?.value || '<?php echo e($user->language_code ?? "ru"); ?>';
    const currencyCode = code && type === 'currency' ? code : document.querySelector('input[name="currency_code"]:checked')?.value || '<?php echo e($user->currency_code ?? "RUB"); ?>';
