<?php $__env->startSection('title', __('common.nutrition_diary')); ?>
<?php $__env->startSection('page-title', __('common.nutrition_diary')); ?>
...
<?php $__env->startSection("sidebar"); ?>
    ...
    <a href="<?php echo e(route("crm.nutrition.index")); ?>" class="nav-link active flex items-center px-4 py-3 rounded-xl mb-2 transition-colors">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php $__env->startSection("mobile-menu"); ?>
    ...
    <a href="<?php echo e(route("crm.nutrition.index")); ?>" class="mobile-nav-link active">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.5 5M7 13l2.5 5m6-5v6a2 2 0 01-2 2H9a2 2 0 01-2-2v-6m8 0V9a2 2 0 00-2-2H9a2 2 0 00-2 2v4.01"/>
        </svg>
        <?php echo e(__('common.nutrition_diary')); ?>
    ...
    <div>
        ...
        <div x-data="nutritionApp()" x-init="loadNutritionPlans(); init();" x-cloak>
            ...
            <div x-show="currentView === 'list'" class="bg-white border border-gray-200 rounded-lg p-6">
                <h4 class="text-md font-semibold text-gray-900 mb-4"><?php echo e(__('common.nutrition_plans')); ?></h4>
                ...
                <div x-show="!loadingNutritionPlans && nutritionPlans.length === 0" class="text-center py-12 text-gray-500">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2"><?php echo e(__('common.no_nutrition_plans')); ?></h3>
                    <p class="text-gray-500"><?php echo e(__('common.no_nutrition_plans_description')); ?></p>
                </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex-1">
                                    <h5 class="text-lg font-medium text-gray-900">
                                        ...
                                        <span class="text-sm text-gray-600" x-text="(() => {
                                            const locale = '<?php echo e(app()->getLocale() === 'ua' ? 'uk-UA' : (app()->getLocale() === 'ru' ? 'ru-RU' : 'en-US')); ?>';
                                            ...
                                            return `(${daysCount} <?php echo e(__('common.days')); ?>, ${monthName} ${plan.year})`;
                                        })()"></span>
                                    </h5>
                                </div>
                                <div class="flex items-center space-x-2">
                                    <button @click="showView(plan)" 
                                            ...
                                            title="<?php echo e(__('common.details')); ?>">
                                        <svg class="-ml-1 mr-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                        </svg>
                                        <?php echo e(__('common.details')); ?>
            ...
            <div id="athlete-nutrition-view-section" x-show="currentView === 'view'" x-transition class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div x-show="currentNutritionPlan" class="space-y-6">
                    <!-- Заголовок -->
                    <h3 class="text-xl font-semibold text-gray-900" x-text="currentNutritionPlan ? (currentNutritionPlan.title || `<?php echo e(__('common.nutrition_plan_for')); ?> ${new Date(0, currentNutritionPlan.month - 1).toLocaleString('<?php echo e(app()->getLocale() === 'ua' ? 'uk-UA' : (app()->getLocale() === 'ru' ? 'ru-RU' : 'en-US')); ?>', {month: 'long'})} ${currentNutritionPlan.year} <?php echo e(__('common.year')); ?>.`) : ''"></h3>
                    
                    <!-- Описание плана -->
                    <div class="mb-6" x-show="currentNutritionPlan.description">
                        <h4 class="text-lg font-medium text-gray-900 mb-2"><?php echo e(__('common.description')); ?></h4>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                        ...
                        <div class="bg-blue-50 rounded-lg p-4 text-center">
                            ...
                            <div class="text-sm text-blue-800"><?php echo e(__('common.total_proteins')); ?> (<?php echo e(__('common.g')); ?>)</div>
                        </div>
                        <div class="bg-yellow-50 rounded-lg p-4 text-center">
                            ...
                            <div class="text-sm text-yellow-800"><?php echo e(__('common.total_carbs')); ?> (<?php echo e(__('common.g')); ?>)</div>
                        </div>
                        <div class="bg-green-50 rounded-lg p-4 text-center">
                            ...
                            <div class="text-sm text-green-800"><?php echo e(__('common.total_fats')); ?> (<?php echo e(__('common.g')); ?>)</div>
                        </div>
                    </div>
                        ...
                        <table class="min-w-full bg-white border border-gray-300 rounded-lg">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b border-gray-300"><?php echo e(__('common.proteins')); ?> (<?php echo e(__('common.g')); ?>)</th>
                                    <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b border-gray-300"><?php echo e(__('common.fats')); ?> (<?php echo e(__('common.g')); ?>)</th>
                                    <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b border-gray-300 carbs-header">
                                        <span class="carbs-full"><?php echo e(__('common.carbs')); ?> (<?php echo e(__('common.g')); ?>)</span>
                                        <span class="carbs-short" style="display: none;">
                                            <?php if(app()->getLocale() === 'ua'): ?>
                                                Вугл. (<?php echo e(__('common.g')); ?>)
                                            <?php else: ?>
                                                Углев. (<?php echo e(__('common.g')); ?>)
                                            <?php endif; ?>
                                        </span>
                                    </th>
                                    ...
                                    <th x-show="hasNotes(currentNutritionPlan)" class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b border-gray-300"><?php echo e(__('common.notes')); ?></th>
                                </tr>
                            </thead>
                    ...
                    <div x-show="!currentNutritionPlan.nutrition_days || currentNutritionPlan.nutrition_days.length === 0" class="text-center py-8 text-gray-500">
                        ...
                        <p><?php echo e(__('common.no_day_data')); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('crm.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\fitrain\resources\views/crm/athlete/nutrition.blade.php ENDPATH**/ ?>