...
<body class="bg-gray-50">
    ...
    <script>
        ...
        function trainerImageSlider() {
            const images = <?php echo json_encode($landing_trainers_images ?? [], 15, 512) ?>;
        ...
        function athleteImageSlider() {
            const images = <?php echo json_encode($landing_athletes_images ?? [], 15, 512) ?>;
