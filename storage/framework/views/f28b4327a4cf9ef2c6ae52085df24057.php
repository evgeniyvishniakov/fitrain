        ...
        lastView: 'list',
            ...
            getExerciseStatusForList(workoutId, exerciseId) {
                ...
                openExerciseDetailModal(exercise) {
                    ...
                    // Видео
                    if (videoUrl) {
                        bodyHTML += `<div style="margin-bottom: 24px;"><h4 style=\"font-size: 16px; font-weight: 600; color: #374151; margin: 0 0 12px 0;\"><?php echo e(__('common.video')); ?></h4>`;
                            ...
                            <div class="workout-title-section flex items-center gap-4">
                                ...
                                <div class="workout-meta flex flex-wrap items-center gap-3 text-sm text-gray-600">
                                    <div class="flex items-center">
                                        ...
                                        <span><?php echo e(optional($workout->date)->format('d.m.Y')); ?></span>
                                    </div>
                                    <div class="flex items-center">
                                        <svg class="w-4 h-4 mr-1 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
