    ...
    return {
        ...
        async loadWorkouts() {
            try {
                ...
                const response = await fetch(`/self-athlete/workouts/api?start_date=${startDate.toISOString().split('T')[0]}&end_date=${endDate.toISOString().split('T')[0]}`);
    ...
    <div class="dashboard-bottom-section" x-data="dashboardCalendar()">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
            <div class="flex items-center justify-between mb-3">
                ...
                <a href="<?php echo e(route('crm.self-athlete.workouts')); ?>" class="text-xs text-indigo-600 hover:text-indigo-700 font-medium">
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make("crm.layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\fitrain\resources\views/crm/self-athlete/dashboard.blade.php ENDPATH**/ ?>