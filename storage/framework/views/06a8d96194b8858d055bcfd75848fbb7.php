        ...
        <div id="sidebar" class="bg-gray-800 text-white w-64 sidebar-transition">
            ...
            <div class="p-6">
                <div class="flex items-center gap-3">
                    <?php if($siteLogo): ?>
                        <img src="<?php echo e(asset('storage/' . $siteLogo)); ?>" alt="Логотип" class="h-10 w-auto object-contain">
                    <?php else: ?>
                        <i class="fas fa-dumbbell text-2xl text-blue-400"></i>
                    <?php endif; ?>
                    <h1 class="text-xl font-bold"><?php echo e($siteName); ?></h1>
                </div>
            </div>
            ...
            <nav class="mt-6">
                ...
                <a href="<?php echo e(route('admin.site.index')); ?>" class="flex items-center px-6 py-3 text-gray-300 hover:bg-gray-700 hover:text-white <?php echo e(request()->routeIs('admin.site*') ? 'bg-gray-700 text-white' : ''); ?>">
