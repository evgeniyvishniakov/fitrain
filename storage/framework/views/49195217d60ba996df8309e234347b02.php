<?php $__env->startSection("title", __('common.athlete_progress')); ?>
<?php $__env->startSection("page-title", __('common.progress')); ?>
...
<?php $__env->startSection("sidebar"); ?>
    <a href="<?php echo e(route("crm.dashboard.main")); ?>" class="nav-link <?php echo e(request()->routeIs('crm.dashboard.main') ? 'active' : ''); ?> flex items-center px-4 py-3 rounded-xl mb-2">
    ...
    <a href="<?php echo e(route("crm.workouts.index")); ?>" class="nav-link <?php echo e(request()->routeIs('crm.workouts.*') ? 'active' : ''); ?> flex items-center px-4 py-3 rounded-xl mb-2 transition-colors">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="<?php echo e(route("crm.athlete.progress")); ?>" class="nav-link active flex items-center px-4 py-3 rounded-xl mb-2 transition-colors">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="<?php echo e(route("crm.nutrition.index")); ?>" class="nav-link <?php echo e(request()->routeIs('crm.nutrition.*') ? 'active' : ''); ?> flex items-center px-4 py-3 rounded-xl mb-2 transition-colors">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="<?php echo e(route('crm.athlete.settings')); ?>" class="nav-link <?php echo e(request()->routeIs('crm.athlete.settings*') ? 'active' : ''); ?> flex items-center px-4 py-3 rounded-xl mb-2 transition-colors">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php $__env->startSection("mobile-menu"); ?>
    <a href="<?php echo e(route("crm.dashboard.main")); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('crm.dashboard.main') ? 'active' : ''); ?>">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6z"/>
        </svg>
        <?php echo e(__('common.dashboard')); ?>
    ...
    <a href="<?php echo e(route("crm.workouts.index")); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('crm.workouts.*') ? 'active' : ''); ?>">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
        </svg>
        <?php echo e(__('common.workouts')); ?>
    ...
    <a href="<?php echo e(route("crm.athlete.progress")); ?>" class="mobile-nav-link active">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
        </svg>
        <?php echo e(__('common.progress')); ?>
    ...
    <a href="<?php echo e(route("crm.nutrition.index")); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('crm.nutrition.*') ? 'active' : ''); ?>">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.5 5M7 13l2.5 5m6-5v6a2 2 0 01-2 2H9a2 2 0 01-2-2v-6m8 0V9a2 2 0 00-2-2H9a2 2 0 00-2 2v4.01"/>
        </svg>
        <?php echo e(__('common.nutrition_diary')); ?>
    ...
    <a href="<?php echo e(route('crm.athlete.settings')); ?>" class="mobile-nav-link <?php echo e(request()->routeIs('crm.athlete.settings*') ? 'active' : ''); ?>">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/>
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
        </svg>
...
<div class="space-y-6 fade-in-up">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900"><?php echo e(__('common.my_progress')); ?></h1>
            <p class="text-gray-600 mt-1"><?php echo e(__('common.track_your_achievements_and_workout_results')); ?></p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600"><?php echo e(__('common.total_workouts')); ?></p>
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($recentWorkouts ? $recentWorkouts->count() : 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600"><?php echo e(__('common.progress_records')); ?></p>
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($progressData ? $progressData->count() : 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600"><?php echo e(__('common.measurements')); ?></p>
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($measurements ? $measurements->count() : 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600"><?php echo e(__('common.last_workout')); ?></p>
                    <p class="text-lg font-bold text-gray-900">
                        <?php if($recentWorkouts && $recentWorkouts->count() > 0): ?>
                            <?php echo e($recentWorkouts->first()->created_at->format('d.m.Y')); ?>

                        <?php else: ?>
                            <?php echo e(__('common.no_data')); ?>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
        <div class="p-6 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-900"><?php echo e(__('common.progress_charts')); ?></h3>
        </div>
        <div class="p-6">
            <!-- Фильтры графиков -->
                ...
                <div class="flex flex-wrap gap-4 items-center">
                    <div class="flex items-center gap-2">
                        ...
                        <select id="timeFilter" class="px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            ...
                            <option value="year"><?php echo e(__('common.last_year')); ?></option>
                        </select>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <select id="chartFilter" class="px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            ...
                            <option value="body"><?php echo e(__('common.fat_percentage_and_muscle_mass')); ?></option>
                            <option value="volumes"><?php echo e(__('common.body_volumes')); ?></option>
                        </select>
                    </div>
                </div>
            </div>
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div id="weightChartContainer" class="bg-white rounded-lg p-4 border border-gray-200">
                    <h4 class="text-lg font-semibold text-gray-900 mb-4"><?php echo e(__('common.weight_dynamics')); ?> (<?php echo e(__('common.kg')); ?>)</h4>
                    <div class="relative h-64 cursor-pointer" onclick="openChartModal('weight', '<?php echo e(__('common.weight_dynamics')); ?> (<?php echo e(__('common.kg')); ?>)')">
                ...
                <div id="bmiChartContainer" class="bg-white rounded-lg p-4 border border-gray-200">
                    <h4 class="text-lg font-semibold text-gray-900 mb-4"><?php echo e(__('common.bmi_dynamics')); ?></h4>
                    <div class="relative h-64 cursor-pointer" onclick="openChartModal('bmi', '<?php echo e(__('common.bmi_dynamics')); ?>')">
                ...
                <div id="bodyFatChartContainer" class="bg-white rounded-lg p-4 border border-gray-200">
                    <h4 class="text-lg font-semibold text-gray-900 mb-4"><?php echo e(__('common.fat_percentage')); ?> (%)</h4>
                    <div class="relative h-64 cursor-pointer" onclick="openChartModal('bodyFat', '<?php echo e(__('common.fat_percentage')); ?> (%)')">
                ...
                <div id="muscleMassChartContainer" class="bg-white rounded-lg p-4 border border-gray-200">
                    <h4 class="text-lg font-semibold text-gray-900 mb-4"><?php echo e(__('common.muscle_mass')); ?> (<?php echo e(__('common.kg')); ?>)</h4>
                    <div class="relative h-64 cursor-pointer" onclick="openChartModal('muscleMass', '<?php echo e(__('common.muscle_mass')); ?> (<?php echo e(__('common.kg')); ?>)')">
                ...
                <div id="bodyVolumesChartContainer" class="bg-white rounded-lg p-4 border border-gray-200 lg:col-span-2">
                    <div class="flex items-center justify-between mb-4">
                        <h4 class="text-lg font-semibold text-gray-900"><?php echo e(__('common.body_volumes')); ?> (<?php echo e(__('common.cm')); ?>)</h4>
                        <select id="volumesFilter" class="px-3 py-2 border border-gray-300 rounded-lg text-sm">
                            <option value="all"><?php echo e(__('common.all_volumes')); ?></option>
                            <option value="chest"><?php echo e(__('common.chest')); ?></option>
                            <option value="waist"><?php echo e(__('common.waist')); ?></option>
                            <option value="hips"><?php echo e(__('common.hips')); ?></option>
                            <option value="bicep"><?php echo e(__('common.bicep')); ?></option>
                            <option value="thigh"><?php echo e(__('common.thigh')); ?></option>
                            <option value="neck"><?php echo e(__('common.neck')); ?></option>
                        </select>
                    </div>
                    <div class="relative h-96 cursor-pointer" onclick="openChartModal('volumes', '<?php echo e(__('common.body_volumes')); ?> (<?php echo e(__('common.cm')); ?>)')">
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white rounded-2xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden">
                ...
                <div class="flex items-center justify-between p-6 border-b border-gray-200">
                    <h3 id="modalTitle" class="text-2xl font-bold text-gray-900"><?php echo e(__('common.chart')); ?></h3>
...
function initCharts() {
    ...
    const measurements = <?php echo json_encode($measurements ? $measurements->all() : [], 15, 512) ?>;
    ...
    try {
        window.weightChart = new Chart(ctx, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: '<?php echo e(__('common.weight')); ?> (<?php echo e(__('common.kg')); ?>)',
                    data: weightData,
                    borderColor: '#3B82F6',
...
function createBMIChart(labels, measurements) {
    ...
    const height = <?php echo e(auth()->user()->height ?? 0); ?>;
    ...
    try {
        window.bmiChart = new Chart(ctx, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: '<?php echo e(__('common.bmi')); ?>',
                    data: bmiData,
                    borderColor: '#10B981',
    ...
    try {
        window.bodyFatChart = new Chart(ctx, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: '<?php echo e(__('common.fat_percentage')); ?> (%)',
                    data: bodyFatData,
                    borderColor: '#F59E0B',
    ...
    try {
        window.muscleMassChart = new Chart(ctx, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: '<?php echo e(__('common.muscle_mass')); ?> (<?php echo e(__('common.kg')); ?>)',
                    data: muscleMassData,
                    borderColor: '#8B5CF6',
    ...
    try {
        window.bodyVolumesChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: '<?php echo e(__('common.chest')); ?> (<?php echo e(__('common.cm')); ?>)',
                    ...
                    {
                        label: '<?php echo e(__('common.waist')); ?> (<?php echo e(__('common.cm')); ?>)',
                    ...
                    {
                        label: '<?php echo e(__('common.hips')); ?> (<?php echo e(__('common.cm')); ?>)',
                    ...
                    {
                        label: '<?php echo e(__('common.bicep')); ?> (<?php echo e(__('common.cm')); ?>)',
                    ...
                    {
                        label: '<?php echo e(__('common.thigh')); ?> (<?php echo e(__('common.cm')); ?>)',
                    ...
                    {
                        label: '<?php echo e(__('common.neck')); ?> (<?php echo e(__('common.cm')); ?>)',
            ...
            options: {
                    ...
                    tooltip: {
                        ...
                        callbacks: {
                            label: function(context) {
                                return context.dataset.label + ': ' + (context.parsed.y || '—') + ' <?php echo e(__('common.cm')); ?>';
                            }
                        }
                    }
                },
                scales: {
                    y: {
                        ...
                        title: {
                            display: true,
                            text: '<?php echo e(__('common.volume')); ?> (<?php echo e(__('common.cm')); ?>)'
                        },
                        afterDataLimits: function(scale) {
                            const max = scale.max;
                            const min = scale.min;
...
function filterChartsByTime(timeFilter) {
    ...
    const allMeasurements = <?php echo json_encode($measurements ? $measurements->all() : [], 15, 512) ?>;
...
function filterVolumesChart(volumesFilter) {
    ...
    switch (volumesFilter) {
        case 'all':
            ...
            break;
        case 'chest':
            hideAllExcept(datasets, ['<?php echo e(__('common.chest')); ?> (<?php echo e(__('common.cm')); ?>)']);
            break;
        case 'waist':
            hideAllExcept(datasets, ['<?php echo e(__('common.waist')); ?> (<?php echo e(__('common.cm')); ?>)']);
            break;
        case 'hips':
            hideAllExcept(datasets, ['<?php echo e(__('common.hips')); ?> (<?php echo e(__('common.cm')); ?>)']);
            break;
        case 'bicep':
            hideAllExcept(datasets, ['<?php echo e(__('common.bicep')); ?> (<?php echo e(__('common.cm')); ?>)']);
            break;
        case 'thigh':
            hideAllExcept(datasets, ['<?php echo e(__('common.thigh')); ?> (<?php echo e(__('common.cm')); ?>)']);
            break;
        case 'neck':
            hideAllExcept(datasets, ['<?php echo e(__('common.neck')); ?> (<?php echo e(__('common.cm')); ?>)']);
            break;
    }
...
<?php echo $__env->make("crm.layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\fitrain\resources\views/crm/athlete/progress.blade.php ENDPATH**/ ?>