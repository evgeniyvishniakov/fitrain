                ...
                <div class="flex items-center gap-3">
                    <?php if($crmLogoLight || $crmLogoDark): ?>
                        <div class="flex items-center">
                            <?php if($crmLogoLight): ?>
                                <img src="<?php echo e(asset('storage/' . $crmLogoLight)); ?>" alt="<?php echo e($siteName); ?> logo" class="crm-logo crm-logo-light h-10">
                            <?php endif; ?>
                            <?php if($crmLogoDark): ?>
                                <img src="<?php echo e(asset('storage/' . $crmLogoDark)); ?>" alt="<?php echo e($siteName); ?> logo" class="crm-logo crm-logo-dark h-10">
                            <?php endif; ?>
                        </div>
                    <?php else: ?>
