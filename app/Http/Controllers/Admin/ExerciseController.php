...
class ExerciseController extends BaseController
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'image' => 'nullable|file|mimes:jpg,jpeg,png,gif,webp,mp4,webm|max:51200',
            'image_2' => 'nullable|file|mimes:jpg,jpeg,png,gif,webp,mp4,webm|max:51200',
            'image_female' => 'nullable|file|mimes:jpg,jpeg,png,gif,webp,mp4,webm|max:51200',
            'image_female_2' => 'nullable|file|mimes:jpg,jpeg,png,gif,webp,mp4,webm|max:51200',
