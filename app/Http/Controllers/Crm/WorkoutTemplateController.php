...
class WorkoutTemplateController extends BaseController
{
    public function index(Request $request)
    {
        ...
        return view('crm.workout-templates.index', compact('templates'));
    }

    public function create()
    {
        $exercises = Exercise::active()->orderBy('name')->get();
        return view('crm.workout-templates.create', compact('exercises'));
    }
    ...
    public function show($id)
    {
        ...
        return view('crm.workout-templates.show', compact('template'));
    }
    ...
    public function edit($id)
    {
        ...
        $exercises = Exercise::active()->orderBy('name')->get();
        return view('crm.workout-templates.edit', compact('template', 'exercises'));
    }
