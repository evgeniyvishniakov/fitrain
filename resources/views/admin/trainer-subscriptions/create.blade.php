...
@section('title', 'Добавить подписку тренера')
@section('page-title', 'Добавить подписку тренера')
    ...
    <div class="bg-white rounded-xl shadow-sm">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900">Новая подписка</h3>
        ...
        <form method="POST" action="{{ route('admin.trainer-subscriptions.store') }}" class="p-6 space-y-6">
            @csrf
                ...
                <div>
                    ...
                    <select name="currency_code" id="currency_code" 
                        ...
                        @foreach($currencies as $currency)
                            <option value="{{ $currency->code }}" {{ old('currency_code', 'UAH') === $currency->code ? 'selected' : '' }}>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="date" name="expires_date" id="expires_date" 
                           value="{{ old('expires_date', date('Y-m-d', strtotime('+1 month'))) }}"
            ...
            <div class="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
                ...
                <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                    <i class="fas fa-save mr-2"></i>Создать подписку
                </button>
            </div>
        </form>
    </div>
