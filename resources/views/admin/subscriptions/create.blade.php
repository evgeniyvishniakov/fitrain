...
@section('title', 'Добавить план подписки')
@section('page-title', 'Добавить план подписки')
    ...
    <div class="bg-white rounded-xl shadow-sm">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900">Новый план подписки</h3>
        ...
        <form method="POST" action="{{ route('admin.subscriptions.store') }}" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                          ...
                          placeholder="Описание плана подписки...">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
                ...
                <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                    <i class="fas fa-save mr-2"></i>Создать план
                </button>
            </div>
        </form>
    </div>
