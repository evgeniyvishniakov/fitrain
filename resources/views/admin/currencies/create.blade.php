...
@section('page-title', 'Добавить валюту')
    ...
    <div class="bg-white rounded-xl shadow-sm">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900">Новая валюта</h3>
        ...
        <form method="POST" action="{{ route('admin.currencies.store') }}" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <select name="symbol_position" id="symbol_position" 
                        ...
                        required>
                    <option value="before" {{ old('symbol_position') === 'before' ? 'selected' : '' }}>Перед суммой ($100)</option>
                    <option value="after" {{ old('symbol_position') === 'after' ? 'selected' : '' }}>После суммы (100₽)</option>
                </select>
            ...
            <div class="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
                <a href="{{ route('admin.currencies.index') }}" class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200">
                    Отмена
                </a>
                <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                    <i class="fas fa-save mr-2"></i>Создать валюту
                </button>
            </div>
        </form>
    </div>
