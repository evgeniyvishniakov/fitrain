...
function templatesApp() {
    return {
        ...
        templates: @json(\App\Models\WorkoutTemplate::active()->with('creator')->get()),
        ...
        showEdit(templateId) {
            ...
            this.formExercises = this.currentTemplate.exercises || [];
            this.selectedExercises = this.currentTemplate.exercises || [];
            this.exerciseSearch = '';
            this.exerciseCategory = '';
            this.exerciseEquipment = '';
                    ...
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex-1">
                            <h3 class="text-xl font-semibold text-gray-900 mb-2">
                                ...
                                <span class="text-gray-500 font-normal" x-text="'(' + (template.exercises || []).length + ' упражнений)'"></span>
                            </h3>
    ...
    <div x-show="currentView === 'view'" x-transition class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div x-show="currentTemplate" class="space-y-6">
            ...
            <div>
                ...
                <div x-show="(currentTemplate?.exercises || []).length > 0" class="space-y-3">
                    <template x-for="(exercise, index) in currentTemplate?.exercises || []" :key="index">
                        <div class="bg-gray-50 rounded-lg p-4">
                            <div class="flex items-center justify-between">
                                <div>
                ...
                <div x-show="(currentTemplate?.exercises || []).length === 0" class="text-center py-8 text-gray-500">
