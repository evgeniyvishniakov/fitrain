...
<head>
    ...
    <style>
        ...
        /* Аватары с буквами - в светлой теме делаем фон светлее и текст черным */
        .theme-light [class*="from-indigo-700"][class*="to-purple-800"],
        .theme-light [class*="from-indigo-800"][class*="to-purple-900"] {
            background: linear-gradient(to bottom right, #c7d2fe, #ddd6fe) !important;
        }
        
        .theme-light [class*="from-indigo-700"][class*="to-purple-800"] span,
        .theme-light [class*="from-indigo-800"][class*="to-purple-900"] span,
        .theme-light .workout-avatar span {
            color: #1e1b4b !important;
            text-shadow: none !important;
        }
        
        /* Аватары с буквами - в темной теме можно сделать немного светлее для контраста */
        .theme-dark [class*="from-indigo-700"][class*="to-purple-800"] {
