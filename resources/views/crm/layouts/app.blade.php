    ...
    <div id="mobile-menu" class="mobile-menu">
        ...
        <div class="mobile-menu-content">
            ...
            <nav class="mobile-menu-nav">
                ...
                <a href="{{ route("crm.progress.index") }}" class="mobile-nav-link {{ request()->routeIs('crm.progress.*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div style="display: none;" class="desktop-sidebar">
            <div class="sidebar flex flex-col flex-grow backdrop-blur-md">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2">
                    ...
                    <a href="{{ route("crm.progress.index") }}" class="nav-link {{ request()->routeIs('crm.progress.*') ? 'active' : '' }} flex items-center px-4 py-3 rounded-xl mb-2 transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                        </svg>
                        Прогресс
