    ...
    <div id="mobile-menu" class="mobile-menu">
        ...
        <div class="mobile-menu-content">
            ...
            <nav class="mobile-menu-nav">
                ...
                <a href="{{ auth()->user()->hasRole('trainer') ? route('crm.workouts.index') : route('crm.athlete.workouts') }}" class="mobile-nav-link {{ request()->routeIs('crm.workouts.*') || request()->routeIs('crm.athlete.workouts*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @else
                    <a href="{{ route("crm.athlete.exercises") }}" class="mobile-nav-link {{ request()->routeIs('crm.athlete.exercises*') ? 'active' : '' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/>
                        </svg>
                        {{ __('common.exercises') }}
                    </a>
                    <a href="{{ route("crm.athlete.progress") }}" class="mobile-nav-link {{ request()->routeIs('crm.athlete.progress*') ? 'active' : '' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @endif
                <a href="{{ auth()->user()->hasRole('trainer') ? route('crm.trainer.settings') : route('crm.athlete.settings') }}" class="mobile-nav-link {{ request()->routeIs('crm.trainer.settings*') || request()->routeIs('crm.athlete.settings*') ? 'active' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div style="display: none;" class="desktop-sidebar">
            <div class="sidebar flex flex-col flex-grow backdrop-blur-md">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2">
                    ...
                    <a href="{{ auth()->user()->hasRole('trainer') ? route('crm.workouts.index') : route('crm.athlete.workouts') }}" class="nav-link {{ request()->routeIs('crm.workouts.*') || request()->routeIs('crm.athlete.workouts*') ? 'active' : '' }} flex items-center px-4 py-3 rounded-xl mb-2 transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                        </svg>
                        {{ __('common.workouts') }}
                    ...
                    @else
                        <a href="{{ route("crm.athlete.exercises") }}" class="nav-link {{ request()->routeIs('crm.athlete.exercises*') ? 'active' : '' }} flex items-center px-4 py-3 rounded-xl mb-2 transition-colors">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/>
                            </svg>
                            {{ __('common.exercises') }}
                        </a>
                        <a href="{{ route("crm.athlete.progress") }}" class="nav-link {{ request()->routeIs('crm.athlete.progress*') ? 'active' : '' }} flex items-center px-4 py-3 rounded-xl mb-2 transition-colors">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                            </svg>
                            {{ __('common.progress') }}
                    ...
                    @endif
                    <a href="{{ auth()->user()->hasRole('trainer') ? route('crm.trainer.settings') : route('crm.athlete.settings') }}" class="nav-link {{ request()->routeIs('crm.trainer.settings*') || request()->routeIs('crm.athlete.settings*') ? 'active' : '' }} flex items-center px-4 py-3 rounded-xl mb-2 transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                        </svg>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="header backdrop-blur-md px-6 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <!-- Заголовок страницы -->
                    <h1 class="page-title text-2xl font-bold">@yield("page-title", "Тренировки")</h1>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative" x-data="{ open: false }" x-cloak>
                            ...
                            <div x-show="open" @click.away="open = false" 
                                ...
                                <a href="{{ auth()->user()->hasRole('trainer') ? route('crm.trainer.settings') : route('crm.athlete.settings') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    </svg>
